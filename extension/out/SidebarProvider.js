...
class SidebarProvider {
    _extensionUri;
    static viewType = 'clipsend.panel';
    _view;
    api;
    userId;
    lastDataItems = [];
    constructor(_extensionUri, userId) {
        this._extensionUri = _extensionUri;
        this.api = new api_1.ClipSendApi();
        this.userId = userId;
    }
    ...
    async handleDownloadFile(id, filename) {
        ...
        const downloadFolder = config.get('downloadFolder') || 'one-way-downloads';
